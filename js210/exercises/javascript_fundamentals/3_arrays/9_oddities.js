...
/*
Both of these return false because strict equality `===` checks if two items are the same object. The result returned by `oddities` is a different array with the same value. No matter what we put, these will always evaluate to false.
*/