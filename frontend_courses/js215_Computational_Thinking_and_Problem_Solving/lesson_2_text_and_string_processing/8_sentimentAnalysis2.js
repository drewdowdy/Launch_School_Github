...
function hasSentiment(word, sentimentRegex) {
  return sentimentRegex.test(word);
}
...
function sentiment(text) {
  ...
  let positives = words.filter(word => hasSentiment(word, positiveRegex));
  let negatives = words.filter(word => hasSentiment(word, negativeRegex));
