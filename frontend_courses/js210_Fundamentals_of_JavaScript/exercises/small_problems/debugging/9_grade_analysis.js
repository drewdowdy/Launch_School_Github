...
function median(nums) {
  // nums.sort(); // 
  nums.sort((a, b) => a - b); // sorts by ascending order
...
// The problem here is that Array.prototype.sort() converts each element to a String before comparison. In order to sort correctly, we should include a comparison function
