...
// The problem is the switch statement. There are no break statements so JS falls through each case to the default case. To prevent this, we can add in the break statements
