...
function placeABet(guess) {
  (function generateRandomInt() { // wrapped in parentheses
...
// When a function declaration is wrapped in parentheses `()`, it becomes a function expression. So the reference to `generateRandomInt()` is only available within those parentheses.
