...
team['ceo'] = 'Kim'; // these need to be strings, not variables
team['scrumMaster'] = 'Alice'; // these need to be strings, not variables
team['developer'] = undefined; // these need to be strings, not variables
...
console.log(`CEO: ${company.team['ceo']}`); // also need strings to access values
console.log(`Scrum master: ${company.team['scrumMaster']}`); // also need strings to access values
