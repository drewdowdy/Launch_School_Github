...
let dog = new Dog('Spike', 5, 'friendly', 'Jim');
console.log(dog.introduce() === "Hello, my name is Spike and I am 5 years old and friendly. Woof woof!");
console.log(dog.greetMaster() === "Hello, Jim. Woof woof!");
