...
function delegate(otherObj, methodName, ...args) {
  return function() {
    let method = otherObj[methodName];
    return method.apply(otherObj, args);
  }
}
...
function delegate(otherObj, methodName, ...args) {
  return function() {              // return a function that...
    otherObj[methodName](...args); // invokes the function of the otherObj
  }
}
